...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'D:\Projects\Python\3D-Orientation-Optimization'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'D:\Projects\Python\3D-Orientation-Optimization\Scripts\deactivate.nu'
